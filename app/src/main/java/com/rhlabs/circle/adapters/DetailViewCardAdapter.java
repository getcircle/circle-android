 ...
 */
public class DetailViewCardAdapter extends CardAdapter {

    public DetailViewCardAdapter(Context context, List<Card> cards) {
        super(context, cards);
    }

    public DetailViewCardAdapter(Context context, List<Card> cards, OnCardHeaderClickedListener cardHeaderEventListener) {
